...
BASEFLAGS := -g
WARNFLAGS := -Weverything -Werror -Wno-unused-parameter -Wno-gnu-anonymous-struct -Wno-nested-anon-types -Wno-c++98-compat -Wno-format-nonliteral -Wno-padded -Wno-unused-exception-parameter

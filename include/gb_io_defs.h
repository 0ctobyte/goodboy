...
#define GB_LCDC_BG_WIN_ENABLE_MASK    (0x1)
#define GB_LCDC_SPRITE_ENABLE_MASK    (0x2)
#define GB_LCDC_SPRITE_SIZE_MASK      (0x4)
#define GB_LCDC_TILE_MAP_SEL_MASK     (0x8)
#define GB_LCDC_TILE_DATA_SEL_MASK    (0x10)
#define GB_LCDC_WIN_ENABLE_MASK       (0x20)
#define GB_LCDC_WIN_TILE_MAP_SEL_MASK (0x40)
#define GB_LCDC_ENABLE_MASK           (0x80)
